...
SPECTACULAR_SETTINGS = {
    "TITLE": "Payment API",
    "DESCRIPTION": "Documentation of API endpoints of Payment API",
    "VERSION": "1.0.0",
...
MOCK_PAYMENTS = env.bool("MOCK_PAYMENTS", False)
NOVINPAY_CORPORATION_PIN = env("NOVINPAY_CORPORATION_PIN", default="")
